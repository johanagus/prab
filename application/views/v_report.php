						...
						<div class="col-12 col-lg-12 col-xxl-12 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<div class="row my-4">
										<div class="col-12">
										<h5><strong>Filter laporan</strong></h5>
                                             <form method="POST" action="<?= base_url('report/filter') ?>">
												<div class="row">
													...
													<div class="col-12 col-md-2">
														<select class="form-control" name="status" id="status">
															...
															<option value="2">Disetujui PIC</option>
															<option value="3">Ditolak</option>
															<option value="4">Selesai</option>
															<option value="5">Disetujui Direksi</option>
														</select>
													</div>
													<div class="col-12 col-md-1">
                                        ...
                                        <table id="example" class="display nowrap" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Departmen</th>
                                                    <th>Cabang</th>
                                                    <th>Total </br> Anggaran ( Rp. )</th>
                                                    <th>Total </br> Pencairan ( Rp. )</th>
													<th>Total </br> Tidak Dicairkan ( Rp. )</th>
													<th>Kekurangan </br> Pencairan ( Rp. )</th>
                                                    <th>Total </br> Penyelesain ( Rp. )</th>
                                                    <th>Kekurangan </br> Penyelesain ( Rp. )</th>
													<th>status</th>
													<th>Detail</th>
                                                </tr>
                                            </thead>
                                            ...
                                            ?>
                                                ...
                                                <tr>
														<td><a href="<?= base_url('report/detail/').$row->id?>"><?= $row->id ?></td>
														...
														<td><?= number_format($row->paid_value,0,',','.'); ?></td>
														<td><?= number_format($row->unpaid_value,0,',','.'); ?></td>
														<td><?= number_format(($row->value-($row->paid_value+$row->unpaid_value)),0,',','.');?></td>
														<td><?= number_format($row->settlement_value,0,',','.'); ?></td>
														<td><?= number_format(($row->paid_value-$row->settlement_value),0,',','.');?></td>
														<td><?= $row->status ?></td>
														<td class="text-center"><a href="<?= base_url('report/detail/').$row->id?>"><i class="align-middle mr-1" data-feather="eye"></i></a></td>
