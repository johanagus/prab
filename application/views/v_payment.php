		...
		<nav id="sidebar" class="sidebar">
          ...
          <span style="letter-spacing: 1px;" class="align-middle">E-PRAB TOPSELL</span>
				...
				<ul class="sidebar-nav">					
                    ...
                    <li class="sidebar-item <?= $d_payment ?> active">
				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Pelunasan PRAB</strong></h3>
						</div>
								...
								<div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-md-4">
                                             <h4>Daftar Pelunasan PRAB </h4>
                                        </div>
                                        <div class="col-12 col-md-8 text-center text-sm-right">
                                            <form class="form-inline d-none d-sm-inline-block mr-3" method="POST" action="<?= base_url();?>payment/search_prab">
								...
								<table class="table table-striped w-100 table-responsive-lg my-0">
									<thead>
										<tr>
											...
											<th class="d-table-cell">Belum Terbayar </br>( Rp. )</th>
											<th class="d-none d-xl-table-cell">Aksi</th>
										</tr>
									</thead>
									<?php foreach($get_approved_prab as $row){ 
									?>
									<tbody>
										<tr>
											<td><?= $row->topic ?></td>
											...
											<td class="d-table-cell text-right"><?= number_format(($row->value-$row->payment_value),0,',','.')?></td>
											<td class="d-table-cell"><a class="text-primary" data-toggle="tooltip" data-placement="left" title="Detail" href="<?= base_url('payment/detail/'.$row->id)?>"><i class="align-middle mr-1" data-feather="eye"></i></a></td>
										</tr>
