...
<head>
	...
	<title>E-PRAB | DETAIL LAPORAN</title>
				...
				<div class="container-fluid p-0">
					<div class="row mb-2 mb-xl-3">
						<div class="col-12 col-sm-6 d-sm-block">
							<h3><strong>LAPORAN DETAIL PENGAJUAN PRAB</strong></h3>
						</div>
						<div class="col-12 col-sm-6 d-sm-block text-right">
                            <button class="btn btn-primary text-white no-print" onclick="window.print()"><i class="align-middle mr-1" data-feather="printer"></i> Cetak</button>
							<a href="<?= base_url(); ?>report" class="btn btn-primary text-white no-print"><strong><i data-feather="corner-up-left"></i></strong> Kembali</a>		
						</div>
					</div>
                    <div class="row">
						<div class="col">
                            <div class="card">
								<div class="card-body">
                                    ...
                                    <!-- Detail PRAB -->
                                        ...
                                        <div class="row my-5">
                                            <div class="col-12">
                                            <h4 class="my-4"><strong>Detail Item</strong></h4>
                                                <table class="table table-striped w-100 my-0">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                        ...
                                        <div class="row my-2 mr-3">
                                            ...
                                            <div class="col-12 col-md-6 text-right mb-3">
                                                ...
                                                <h4 class="pl-1 text-primary"><strong>Rp. <?= number_format($value_prab,0,',','.')  ?></strong> </h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <h4 class="my-4"><strong>Detail Pencairan</strong></h4>
                                                <table class="table table-striped w-100 my-0">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                        ...
                                        <div class="row my-3 mr-3">
                                            ...
                                            <div class="col-12 col-md-6 text-right mb-3">
                                                ...
                                                <h4 class="pl-1 text-primary"><strong>Rp. <?php if($total_payment > 0 ){ echo number_format($total_payment,0,',','.');}else{ echo 0;} ?></strong> </h4>
                                            </div>
                                        </div>
                                    

                                        <!-- End Detail Pencairan -->

                                        <!-- Detail Penyelesain -->
                                        
                                        <div class="row">
                                            <div class="col-12">
                                                <h4 class="my-4"><strong>Detail Penyelesaian</strong></h4>
                                        ...
                                        <div class="row float-right m-3">
                                            <div class="col-auto text-right mb-3">
                                                ...
                                                <?php
                                                if($total_payment > 0){ 
                                                    echo number_format(($total_payment-$total_settlement),0,',','.'); 
                                                }else{ 
