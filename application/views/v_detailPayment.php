...
<head>
	...
	<title>E-PRAB | Pelunasan PRAB</title>
...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
          ...
          <span style="letter-spacing: 1px;" class="align-middle">E-PRAB TOPSELL</span>
				...
				<ul class="sidebar-nav">					
                    ...
                    <li class="sidebar-item active <?= $d_payment ?>">
				...
				<div class="container-fluid p-0">
					<div class="row mb-2 mb-xl-3">
						<div class="col-12 col-sm-6 d-sm-block">
							<h3><strong>PENCAIRAN PRAB</strong></h3>
						</div>
						<div class="col-12 col-sm-6 d-sm-block text-right">
							<a href="<?= base_url(); ?>payment" class="btn btn-primary text-white"><strong><i data-feather="corner-up-left"></i></strong> Kembali</a>
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <h2 class="mb-0">
                                                        ...
                                                        <i style="font-size: 20px;" data-feather="arrow-down-right"></i> Detail Pencairan
                                                        </button>
                                                    </h2>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-12 col-md-6 text-left mb-3">
                                                                ...
                                                                <h4 class="pl-1"><strong>Rp. <?= number_format($value_prab,0,',','.')  ?></strong> </h4>
                                                            </div>
                                                            <div class="col-12 col-md-6 text-right mb-3">
                                                                <a class="btn btn-primary text-white" data-toggle="modal" data-target="#ModalAddPayment">+ Buat Pencairan</a>
                                                                <a class="btn btn-warning text-white" data-toggle="modal" data-target="#ModalAddNotPaid">+ Tidak dicairkan</a>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <table class="table table-striped w-100 table-responsive-lg my-0">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th>Tanggal</th>
                                                                            <th class="d-table-cell">Uraian</th>
                                                                            <th class="d-table-cell">Jumlah </br> pencairan ( Rp. )</th>
                                                                            <th class="d-table-cell">Metode </br> pembayaran</th>
                                                                            <th class="d-table-cell">Via Rek</th>
                                                                    ...
                                                                    ?>
                                                                        <tr class="<?= $is_paid ?>">
                                                                            ...
                                                                            <td width="150px" class="d-table-cell text-right"><?= number_format($row->value,0,',','.'); ?></td>
                                                                            <td class="d-table-cell"><?= $row->payment_methode ?></td>
                                                                            <td class="d-table-cell"><?= $row->account_number ?></td>
                                                                            <td class="d-table-cell text-center">
                                                                            <a class="text-danger" data-toggle="tooltip" data-placement="left" title="Batal pencairan" href="<?= base_url()?>payment/cancel_payment/<?= $row->id ?>/<?= $this->uri->segment(3);?>"><i class="align-middle mr-1" data-feather="delete"></i></a>
                                                                            <?php if($row->is_paid == 0){

                                                                            }else{ ?>
                                                                                <a class="text-primary" data-toggle="tooltip" data-placement="left" title="Cetak pencairan" href="<?= base_url()?>payment/print/<?= $this->uri->segment(3);?>/<?= $row->id ?>"><i class="align-middle mr-1" data-feather="printer"></i></a></td>
                                                                            <?php } ?>
                                                                        </tr>
                                                                    ...
                                                                    <?php } ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="d-table-cell text-right"><strong><?php if($total_payment > 0 ){ echo number_format($total_payment,0,',','.');}else{ echo 0;} ?></strong></td>
                                                        ...
                                                        <div class="row float-right m-3">
                                                            <div class="col-auto text-left mb-3">
                                                                <p class="text-muted m-1 p-0">Belum Terbayar</p>
                                                                <h4 class="pl-1 text-primary"><strong>Rp. 
                                                                <?php
                                                                if($total_payment > 0){ 
                                                                    echo number_format(($value_prab-$total_payment),0,',','.'); 
                                                                }else{ 
                                                                    echo number_format($value_prab,0,',','.'); 
                                                                }; 
                                                                ?>
                                                                </strong> </h4>
                                                            </div>
        ...
        <!-- Modal add Payment -->
        <div class="modal fade" id="ModalAddPayment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form id="form-add-payment" action="<?= base_url(); ?>payment/add_payment" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Pencairan Baru</h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label"><strong>Uraian</strong></label>
                            <textarea type="text" name="description" class="form-control py-3" placeholder="Masukan uraian pencairan" required oninvalid="this.setCustomValidity('Silahkan lengkapi uraian pencairan !')" oninput="setCustomValidity('')"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label"><strong>Jumlah Pencairan ( Rp. )</strong></label>
                            <input type="text" name="value" class="form-control py-3" placeholder="Masukan jumlah pencairan" required oninvalid="this.setCustomValidity('Silahkan masukan jumlah pencairan !')" oninput="setCustomValidity('')">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><strong>Jenis Pembayaran</strong></label>
                            <select class="form-control" name="payment_methode" id="payment_methode">
                                <option class="form-control" value="Cash">Cash</option>
                                <option class="form-control" value="Transfer">Transfer</option>
                            </select>
                        </div>
                        <div id="account_number" class="form-group d-none">
                            <label class="form-label"><strong>Via Rekening</strong></label>
                            <input type="text"  name="account_number" class="form-control py-3 " placeholder="Masukan rekening transfer">
                        </div>
                        <input type="hidden" name="prab_id" value="<?= $this->uri->segment(3); ?>">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button id="btn-add-payment" type="submit" class="btn btn-primary">Simpan</button>
                    </div>
                    </form>
                </div>
            </div>
        ...
        <!-- Modal add not paid -->
        <div class="modal fade" id="ModalAddNotPaid" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form id="form-add-payment" action="<?= base_url(); ?>payment/add_not_paid" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Tidak dicairkan</h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label"><strong>Uraian</strong></label>
                        ...
                        <div class="form-group">
                            <label class="form-label"><strong>Jumlah yang tidak cairkan ( Rp. )</strong></label>
                            <input type="text" name="value" class="form-control py-3" placeholder="Masukan jumlah pencairan" required oninvalid="this.setCustomValidity('Silahkan masukan jumlah pencairan !')" oninput="setCustomValidity('')">
                        </div>
                    <div class="modal-footer">
                        <input type="hidden" name="prab_id" value="<?= $this->uri->segment(3); ?>">
    ...
    $('#form-add-payment').submit(function()
    {
