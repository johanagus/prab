		...
		<nav id="sidebar" class="sidebar">
          ...
          <span style="letter-spacing: 1px;" class="align-middle">E-PRAB TOPSELL</span>
				...
				<ul class="sidebar-nav">					
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="<?= base_url('bill/'); ?>">
                            <i class="align-middle" data-feather="check"></i> <span class="align-middle">Piutang Principle</span>
                        </a>
					</li>
					<li class="sidebar-item">
						...
						<div class="col">
                            <div class="card">
								<div class="card-body">
                                    ...
                                    <div class="row">
                                    <?php foreach($prab_data as $row){ 
										$value_prab = $row->value;
									?>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label class="form-label"><strong>Tema</strong></label>
                                                <input type="text" class="form-control" name="topic" value="<?= $row->topic; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>Latar Belakang</strong></label>
                                                <input type="text" name="background" class="form-control py-3" value="<?= $row->background; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>Tujuan</strong></label>
                                                <input type="text" name="goal" class="form-control py-3"  value="<?= $row->goal; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>PIC / Penanggung Jawab</strong></label>
                                                <input type="text" name="pic" class="form-control py-3"  value="<?= $row->pic; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="location" class="form-control py-3"  value="<?= $row->location; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>Tanggal Pelaksanaan</strong></label>
                                                <input type="text" name="event_date" class="form-control py-3"  value="<?= date('d-m-Y', strtotime($row->event_date)); ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>Keterangan Tambahan</strong></label>
                                                <input type="text" name="description" class="form-control py-3" value="<?= $row->description; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"><strong>Fasilitas Pendukung</strong></label>
                                                <input type="text" name="supporting_facilities" class="form-control py-3"  value="<?= $row->supporting_facilities; ?>" disabled>
                                            </div>  
                                        </div>
                                    <?php } ?>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center mb-3 text-md-right col-md-6">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-table-cell">
															<a class="text-danger" href="<?= base_url()?>dashboard/delete_group_items/<?= $row->id ?>/<?= $this->uri->segment(3);?>?redirect=add_group_item">
													...
													if ($items->num_rows() > 0) { 
														...
														<tr>
															...
															<td class="d-table-cell"><a class="text-danger" data-toggle="tooltip" data-placement="left" title="hapus item" href="<?= base_url()?>dashboard/delete_item/<?= $items_row->id ?>/<?= $this->uri->segment(3); ?>/<?= $row->id ?>?redirect=add_group_item"><i class="align-middle mr-1" data-feather="delete"></i></a></td>
														</tr>
														<?php }
														}
                                            ...
                                            <table class="table table-striped w-100 table-responsive-lg my-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-table-cell">
															<a class="text-danger" href="<?= base_url()?>dashboard/delete_financing_support/<?= $row->id ?>/<?= $this->uri->segment(3);?>?redirect=add_group_item">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<input type="hidden" name="redirect" value="add_group_item">
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<div class="form-group">
                            <label class="form-label"><strong>Type / Merk / Spec. </strong></label>
                            <textarea type="text"  name="item_detail" class="form-control py-3" placeholder="Type merk atau spesifikasi" required oninvalid="this.setCustomValidity('Silahkan lengkapi merek / spesifikasi item !')" oninput="setCustomValidity('')"></textarea>
                        </div>
                        <div class="form-group">
						...
						<input type="hidden" id="redirect" name="redirect" value="dashboard/add_group_item/<?= $this->uri->segment(3); ?>">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
