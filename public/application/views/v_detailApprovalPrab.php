...
<head>
	...
	<title>E-PRAB | Detail PRAB</title>
	...
	<div class="wrapper">
		...
		<div class="main">
				...
				<div class="container-fluid p-0">
					<div class="row mb-2 mb-xl-3">
						<div class="col-12 col-sm-6 d-sm-block">
							<h3><strong>Detail PRAB</strong></h3>
						</div>
						<div class="col-12 col-sm-6 d-sm-block text-right">
							<a href="<?= base_url(); ?>approval" class="btn btn-primary text-white"><strong><i data-feather="corner-up-left"></i></strong> Kembali</a>
						</div>
					</div>
                    <div class="row">
						<div class="col">
                        <div class="card">
								<div class="card-body">
                                        <?php foreach($detail_prab as $row){ $value_prab= $row->value?>
											<div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
												...
												<div class="col-12">
													<table class="table table-striped w-100 table-responsive-lg my-0">
														...
														<tbody>
															<?php
																$total_support = 0;
																foreach($financing_support as $row){
																$total_support += $row->value;
															?>
															<tr>
											...
											<div class="row m-3">
												<div class="col-12 text-right mb-3">
													<p class="text-muted m-1 p-0">Total Biaya Support</p>
													<h4 class="pl-1 text-primary"><strong>Rp. 
													<?= number_format($total_support,0,',','.')?>
													</strong> </h4>
												</div>
											</div>
                                        </div>
                                    </div>
									<div class="row my-2 mt-4 footer-action">
										<div class="col text-right">
											<a href="" data-toggle="modal" data-target="#ModalReject" class="btn btn-danger text-white"><strong><i data-feather="x-square"></i></strong> Tolak</a>
											<a href="" data-toggle="modal" data-target="#ModalApprove" class="btn btn-success text-white"><strong><i data-feather="check-square"></i></strong> Setujui</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal fade" id="ModalApprove" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-default modal-sm" role="document">
					<div class="modal-content">
						<form action="<?= base_url(); ?>approval/approve" method="post">
						<div class="modal-header">
							<h4 class="modal-title text-primary" id="exampleModalLongTitle"><i data-feather="alert-triangle"></i> Konfirmasi</h4>
						</div>
						<div class="modal-body">
							<div class="modal-body m-3">
								<p class=" text-center mb-0">Apakah anda ingin mensetuji PRAB ini ?</p>
							</div>
							<div class="form-group">
								<label class="form-label"><strong>Tambahkan catatan</strong></label>
								<textarea type="text" cols="2" row="3" name="approve_note" class="form-control py-3" placeholder="Ketik catatan (optional)"></textarea>
							</div>
			...
			<div class="modal fade" id="ModalReject" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-default modal-sm" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="modal-body m-3">
								<p class=" text-center mb-0">Apakah anda ingin menolak PRAB ini ?</p>
							</div>
							<div class="form-group">
								<label class="form-label"><strong>Tambahkan catatan</strong></label>
								<textarea type="text" cols="2" row="3" name="note" class="form-control py-3" placeholder="Ketik catatan (optional)"></textarea>
							</div>
							<label class="custom-control custom-checkbox">
								<input type="checkbox" name="modify" value="1" class="custom-control-input">
								<span class="custom-control-label">Izinkan perbaikan</span>
							</label>
							<input type="hidden" name="prab_id" value="<?= $this->uri->segment(3); ?>">
						</div>
						<div class="modal-footer">
