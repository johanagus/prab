...
<body>
	<div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
								<div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 alert-warning p-3 rounded">
        ...
        <div class="modal fade" id="ModalAddGroup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form action="<?= base_url(); ?>dashboard/add_new_group_item" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="group_name" class="form-control py-3" placeholder="Nama kelompok item">
                        </div>
        ...
        <div class="modal fade" id="ModalAddItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form action="<?= base_url(); ?>dashboard/add_new_item" method="post">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="item_description" class="form-control py-3" placeholder="Uraian item">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><strong>Merk / Type / Spec.</strong></label>
                            <input type="text" name="item_detail" class="form-control py-3" placeholder="Type, Merk atau spesifikasi">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><strong>Jumlah</strong></label>
                            <input type="number" min="1" name="qty" class="form-control py-3" placeholder="Jumlah item">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><strong>Harga satuan</strong></label>
                            <input type="text" name="value" class="form-control py-3" placeholder="Harga satuan ( Rp. )">
                        </div>
                        <div class="form-group">
